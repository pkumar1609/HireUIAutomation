...
public class TC375 extends baseclass {

@Given("^Job must be share to market place$")
public void job_must_be_share_to_market_place(DataTable arg1) throws Throwable {
    
}

@And("^Login with agency one$")
public void login_with_agency_one() throws Throwable {
...
public void navigate_to_agency_workbench_tab() throws Throwable {

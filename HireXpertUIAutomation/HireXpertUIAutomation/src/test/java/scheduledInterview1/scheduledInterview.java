...
public class scheduledInterview extends baseclass {
	...
	public void click_on_Schedule_Interview_icon_from_candidate_card() throws Throwable {
		...
		Thread.sleep(1000);
		String candidateName = "c01";
		
		String xpath_start_card = "//*[@id=\"cdk-drop-list-32\"]/div[";
		String xpath_end_card = "]";
		//*[@id="cdk-drop-list-32"]/div[1]
		//*[@id="cdk-drop-list-32"]/div[2]
		
		String xpath_start_cardName = "//*[@id=\"cdk-drop-list-48\"]/div[";
		String xpath_end_cardName = "]/div/div[1]/div[1]/h6/span";
		//*[@id="cdk-drop-list-48"]/div[3]/div/div[1]/div[1]/h6/span
		//*[@id="cdk-drop-list-48"]/div[2]/div/div[1]/div[1]/h6/span
		//*[@id="cdk-drop-list-48"]/div[1]/div/div[1]/div[1]/h6/span	
		
		String xpath_start_schedule = "//*[@id=\"cdk-drop-list-32\"]/div[";
		String xpath_end_schedule = "]/div/div[4]/button[2]";
		//*[@id="cdk-drop-list-32"]/div[1]/div/div[4]/button[2]
		//*[@id="cdk-drop-list-32"]/div[2]/div/div[4]/button[2]
		
		int i = 1;
		
		while(isElementPresent(xpath_start_card+i+xpath_end_card)) {
			
			String s02 = driver.findElement(By.xpath(xpath_start_cardName+i+xpath_end_cardName)).getText();
			System.out.println(s02);
			
			if(s02.equalsIgnoreCase(candidateName)) {
				System.out.println("\nCandidate found: " + s02);
				Thread.sleep(3000);
				
				WebElement we = driver.findElement(By.xpath(xpath_start_schedule+i+xpath_end_schedule));		
				we.click();
				System.out.println("Clicked on scheduled interview icon of selected candidate card..");
			}
	...
	public boolean isElementPresent(String elementXpath) {
		...
		if(count==0) {
			System.out.println("\nCandidate cards are not available..");
			return false;
		}
		else {
			System.out.println("\nCandidate cards are available..");
			return true;
		}

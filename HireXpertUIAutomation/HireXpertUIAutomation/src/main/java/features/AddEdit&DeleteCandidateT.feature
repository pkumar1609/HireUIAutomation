...
Examples:
   | Title    | Designation   | Industry    | JobRole  | Location    | Budget | MinExp | MaxExp | NoOfInterviews |JobName                     |    CandidateEmail       |  Name   |   ContactNumber  |   Designation     | Gender | NoticePeriod | Location    |  Communicationmode |   contactnumber   | 
   | Engineer | Test Engineer | IT-Software | Engineer | Viman Nagar | 500000 | 2      | 3      | 3              | Engineer - EmpOrg - Active | candidate05@gmail.com   | Can05   |   912349699666   |   Software Tester | Male   |      30      | pune        |        SMS         |   123456789       |

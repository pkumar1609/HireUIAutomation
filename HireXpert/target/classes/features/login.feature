...
|Tsk1             |Tas1 Note   |
And Click on submit
And the task added should display on both team member as well as employer dash board
And Go to workbench
And Select a job and click on add task button
And In add task popup, Fill all the mandatory details like , Title, Team, assign to Himeself
And Click on submit 
Then the task added should display on both team member as well as employer dashboard for particular job

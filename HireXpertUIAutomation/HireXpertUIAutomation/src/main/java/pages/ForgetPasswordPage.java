...
public class ForgetPasswordPage extends baseclass {
	...
	public WebElement searchToEmail;
	...
	public void webTable(String colName, String colData) {
		...
		List<WebElement> noOfRows = driver
				.findElements(By.xpath("//div[@class='PerformanceAnalysisTableHeight']//tbody//tr"));
		boolean f = false;
		for (int i = 1; i <= noOfRows.size(); i++) {
			String value = driver.findElement(By.xpath(
					               "//div[@class='PerformanceAnalysisTableHeight']//tbody//tr[" + i + "]//td[" + columnIndex + "]")).getText();
	...
	public boolean searchTableRow(WebElement thead, WebElement tbody, String columnHeaderName, String textToSearch) {
		try {
			...
			for (WebElement row : tableRow) {
				WebElement tableColumn = row
						.findElement(By.xpath(".//td[" + columnHeaderData.get(columnHeaderName.trim()) + "]"));

package DeleteQuestionnarieStepDefinationPackageT;
...
public class DeleteQuestionnarieStepDefination extends baseclass {
	...
	public void login_as_Employer() throws InterruptedException  {
	...
	@When("^Select one job from job drop down$")
	public void select_one_job_from_job_drop_down() throws InterruptedException  {
	...
	@When("^click on Save Changes button\\.$")
	public void click_on_Save_Changes_button1() throws InterruptedException {

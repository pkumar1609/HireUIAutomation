...
public class MarketplaceBvt extends baseclass {
	...
	public void job_should_be_list_out_in_market_place_page_on_employer_side() throws Throwable {
		...
		boolean jobAddedOnMarketPlace = driver
				.findElement(By.xpath("//h5[contains(text(), 'Marketplace Jobs')]//following::a[text()='"
						+ addjobpage.jobname + "']")) != null;
	...
	public void agreement_popup_should_show_request_information_in_read_only_mode(DataTable credentials)
			throws Throwable {
	...
	public void enter_basic_details_of_candidate(String CandidateEmail, String profiletitle, String Name,
			...
			String Salaryoffered, String distance, String permanentAddress, String relocate) throws Throwable {

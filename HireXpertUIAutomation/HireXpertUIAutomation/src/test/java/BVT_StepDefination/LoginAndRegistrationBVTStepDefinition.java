...
//	}
	...
	public void update_agency_profile(String Address, String OrganizationName, String Website, String City)
			throws Throwable {
	...
	public void update_employer_profile(String Address, String OrganizationName, String Website, String City)
			throws Throwable {
	...
	public void update_candidate_profile(String title1, String Designation, String functionalArea, String shift,
			String jobType, String NoticePeriod, String industry, String CandidateCity, String gender1,
			String experience, String CTC, String expectedCTC, String CityArea, String expertiselevel)
			throws InterruptedException {

		Thread.sleep(3000);
		updateprofilepopuppage.UpdateProfileCandidate(title1, Designation, functionalArea, shift, jobType, NoticePeriod,
				industry, CandidateCity, gender1, experience, CTC, expectedCTC, CityArea);
		Thread.sleep(3000);
	...
	public void enter_details_of_already_registered_user(String name, String email, String contactnumber)
			throws Throwable {
	...
	public void enter_all_details_and_email_id_of_a_previously_registered_employer(String EmployerName,
			String EmployerEmail, String EmployerContactNumber) throws Throwable {
...
//	}
	...
	public void enter_agency_details(String AgencyName, String AgencyEmail, String AgencyContactNumber)
			throws Throwable {
	...
	public void select_value_from_dropdown_for_agency(String AgencyUserType, String timezone, String country)
			throws Throwable {
	...
	public void enter_candidate_details(String CandidateName, String CandidateEmail, String CandidateContactNumber)
			throws Throwable {
	...
	public void select_value_from_dropdown_for_candidate(String CandidateUserType, String timezone, String country)
			throws Throwable {
...
//		registerpage.clickEmployerAgencySignInlink();
	...
	public void enter_details_of_already_registered_candidate(String candidatename, String candidateemail,
			String candidatecontactnumber) throws Throwable {
...
//	}
	...
	public void enter_details_of_already_registered_agency(String agencyname, String agencyemail,
			String agencycontactnumber) throws Throwable {
	...
	public void enter_details_of_already_registered_employer(String employername, String employeremail,
			String employercontactnumber) throws Throwable {
	...
	public void verify_that_user_has_redirected_to_correct_page_or_not_after_filling_the_information_in_update_profile()
			throws Throwable {
...
//		loginpage.identifyUserK();
	...
	public void enter_employer_details(String EmployerName, String EmployerEmail, String EmployerContactNumber)
			throws Throwable {
	...
	public void select_value_from_dropdown_for_employer(String usertype, String timezone, String country)
			throws Throwable {
	...
	public void enter_the_Current_Password_and_New_Password(String password, String newpassword, String confirmpassword)
			throws Throwable {
...
//		}
	...
	public void user_should_get_error_message_as_when_he_try_to_login_with_old_password(String ExpectedErrorMessage)
			throws Throwable {
		Thread.sleep(2000);
	...
	public void verify_the_Auto_Populated_fields_on_candidate_update_profile_popup_window(String CandidateEmail,
			String CandidateName, String ContactNumber) throws Throwable {
		Thread.sleep(2000);
...
//			}
	...
	public void verify_user_login_as_Employer_has_redirect_on_correct_employer_update_profile_or_not()
			throws Throwable {
	...
	public void verify_user_login_as_Candidate_has_redirect_on_correct_candidate_update_profile_or_not()
			throws Throwable {
	...
	public void vendor_user_enters_valid_credentials(String Username, String Password, String VendorOrg,
			String VendorOrgWebsite, String City, String VendorAddress) throws Throwable {

		loginpage.loginInAsVendor(Username, Password);

		try {
			WebElement updateProfileDialogTitle = driver
					.findElement(By.xpath("//h5[contains(text(),'Update Profile')]"));
			if (updateProfileDialogTitle.isDisplayed()) {
				...
				driver.findElement(By.xpath("//input[@placeholder='Enter City' and @formcontrolname='CityId']"))
						.sendKeys(City);
				driver.findElement(By.xpath("//textarea[@id='agencyaddress' and @placeholder='Enter Address']"))
						.sendKeys(VendorAddress);
				common.ClickSumbit();
			}
		} catch (NoSuchElementException e) {
	...
	public void enter_valid_and_for_registered_employer_and_click_on_Sign_in_button(String Username, String Password,
			String TeamIdMemberCity, String TeamIdMemberAddress) throws Throwable {
		...
		try {
			...
			if (updateProfileDialogTitle.isDisplayed()) {
				driver.findElement(By.xpath("//input[@placeholder='Enter City' and @formcontrolname='CityId']"))
						.sendKeys(TeamIdMemberCity);
				driver.findElement(By.xpath("//textarea[@id='agencyaddress' and @placeholder='Enter Address']"))
						.sendKeys(TeamIdMemberAddress);
				common.ClickSumbit();
			}
		} catch (NoSuchElementException e) {
			dashboardpage.openDashboardPage();

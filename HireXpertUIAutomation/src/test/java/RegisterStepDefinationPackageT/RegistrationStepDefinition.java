...
package RegisterStepDefinationPackageT;
...
public class RegistrationStepDefinition extends baseclass  {
	...
	@Then("^enter employer email and password \"([^\"]*)\" \"([^\"]*)\"$")
	...
	public void select_value_from_dropdown_for_agency(String EmployerUserType, String timezone, String country) throws Throwable {
	...
	@Then("^enter agency email and password \"([^\"]*)\" \"([^\"]*)\"$")
	...
	@Then("^enter candidate email and password \"([^\"]*)\" \"([^\"]*)\"$")
...
//	@When("^Verify the employer username by which employer is login$")
//	public void verify_the_employer_username_by_which_employer_is_login() throws Throwable {
//		
//		Thread.sleep(3000);
//	    
//		wp.VerifytheEmployerUsername();
//	}
//
//	@When("^Verify the agency username by which agency is login$")
//	public void verify_the_agency_username_by_which_agency_is_login() throws Throwable {
//		
//		Thread.sleep(3000);
//	
//		wp.VerifytheAgencyUsername();
//	}
//
//	@When("^Verify the candidate username by which candidate is login$")
//	public void verify_the_candidate_username_by_which_candidate_is_login() throws Throwable {
//		
//		Thread.sleep(3000);
//		
//	    wp.VerifytheCandidateUsername();
//	}

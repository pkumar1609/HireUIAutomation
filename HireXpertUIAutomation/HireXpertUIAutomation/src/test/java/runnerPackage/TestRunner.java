...
tags=("@login,@register,@forgetPassword,@resetPassword,@JobWorkflow,@jobupdate,@interview,@JobCandidateManagement,@JCWF,@Job,@JobQuestionary,@JobCandidteOffered,@Dashboard,@candidatePool")

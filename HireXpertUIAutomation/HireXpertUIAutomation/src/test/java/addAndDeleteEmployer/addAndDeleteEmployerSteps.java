...
public class addAndDeleteEmployerSteps extends baseclass {
	...
	public void fill_the_employer_details_click_on_submit_button(DataTable dt) throws Throwable {
	    
		List<List<String>> data = dt.raw();
		
		addjobpage.employerName.sendKeys(data.get(0).get(0));
		addjobpage.employerEmail.sendKeys(data.get(0).get(1));
		addjobpage.employerContactNumber.sendKeys(data.get(0).get(2));

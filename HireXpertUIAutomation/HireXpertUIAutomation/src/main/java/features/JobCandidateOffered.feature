...
|pemp@gmail.com | 12345  | hircadjof01@gmail.com| hircadjof01 | 9121601966   | Software Tester|04/08/1999| Male  |   No          |  30          |  3        | 450000 | 600000     | India  | Pune | Viman Nagar| 411014 |        SMS         |             | 4      | No             | No     | EmpOrg         |123456789    |Interview1 | 20   | 00     |   0		   | 15 Minutes   |(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi| 18/6/2021 | pe2		      |pe2@gmail.com   |
...
Examples:
|Username       |Password| CandidateEmail        | Name       | ContactNumber | Designation     |Date       | Gender |OnNoticePeriod | NoticePeriod |experience | CTC    |expectedCTC | Country|City  |CityArea    |ZipCode |  Communicationmode |Salaryoffered|distance|permanentAddress|relocate|OrganizationName|contactnumber|Title      | Hour | Minute |DurationHour|DurationMinute|TimeZone                     				      |ScheduledOn|InterviewerName|InterviewerEmail|
|pagy@gmail.com | 12345  | hircadjof02@gmail.com | hircadjof02| 9121601966    | Software Tester |04/08/1999 | Male   |   No          |  30          |  2.5      | 450000 | 600000     | India  | Pune | Viman Nagar| 411014 |        SMS         |             | 4      | No             | No     | EmpOrg         |123456789    |Interview1 | 20   | 00     |   0		   | 15 Minutes   |(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi| 18/6/2021 | pe2		      |pe2@gmail.com   |
...
|pemp@gmail.com | 12345  | hircadjof03@gmail.com | hircadjof03| 9105601966   |Software Tester|04/08/1999 | Male   |   No          |  30          |  2.5      | 300000 | 400000     | India  | Pune | Viman Nagar| 411014 |  SMS             |             |380000        |4      | No             | No     | EmpOrg         |123456789     |(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi|
...
And Newly registered employer user creates new job 
...
|pemp@gmail.com  |EmpNew01@gmail.com |12345   | hircadjof04@gmail.com| hircadjof04 |EmpNew01 |9121601966   |Software Tester|04/08/1999 | Male   |   No          |  30          |  2.5      | 300000 | 400000     | India  | Pune | Viman Nagar| 411014 |  SMS             |             |  380000      |4       | No             | No     | EmpOrg         |123456789    |(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi|
...
And Newly registered agency user creates new job 
| title     | agytitle         | designation | industry    | location | budget | minexp | maxexp | minsal | maxsal | Name | Email         | contact | totalinterviews | organization | agyorganization | functionalArea |
| Developer | Agynew Developer | developer   | IT software | pune     | 400000 |      1 |      2 | 450000 | 800000 | pe1  | pe1@gmail.com | 1234564 |   1             | Hirexpert    | rahitech        | java           |
And Click on add candidate
And Enter All details of "<CandidateEmail>","<CandidateName>","<ContactNumber>","<Designation>","<Date>","<Gender>","<OnNoticePeriod>","<NoticePeriod>","<LastWorkingDay>","<experience>","<CTC>","<expectedCTC>","<Country>","<City>","<CityArea>","<ZipCode>","<Communicationmode>","<Salaryoffered>","<distance>","<permanentAddress>","<relocate>","<Skill1>","<Skill2>","<Skill3>","<level1>","<level2>","<level3>","<Weightage1>","<Weightage2>","<Weightage3>","<certificate1>","<certificate2>","<certificate3>","<remark1>","<remark2>","<remark3>","<certificateforskill1>"and"<certificateforskill2>"
...
|pagy@gmail.com |agencyNew01@gmail.com |12345   | hircadjof05.com| hircadjof05   |agencyNew01   |9101601966   |Software Tester|04/08/1999 | Male   |   No          |  30          |  2.5      | 300000 | 400000     | India  | Pune | Viman Nagar| 411014 |  SMS             |             |  380000      |4       | No             | No     | EmpOrg         |123456789    |(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi|
...
|pemp@gmail.com |EmpNewk01@gmail.com|12345   | hircadjof06@gmail.com| hircadjof06  |EmpNewk01       |9120301966   |Software Tester|04/08/1999 | Male   |   No          |  30          |  2.5      | 300000 | 400000     | India  | Pune | Viman Nagar| 411014 |  SMS             |             |  380000      |4       | No             | No     | EmpOrg         |123456789    |(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi|
...
Then Verify on Job Offerred menu Candidate should display in the Incomplete information column "<Name>" 
And Logout from App
And Newly registered user logged in to Application "<NewEmployerName>" "<NewEmployerLogin>" "9410123214" "Employer" "<TimeZone>" "<Country>" "<Password>" "Hyderabad" "EmpNewkORG" "EmpNewkORG.com" "Hyderabad" 
And Newly registered employer user creates new job 
| JobTitle| Designation|Industry     |FunctionalArea     |Location | Budget | MinSal| MaxSal | MinExp | MaxExp|NoOfInterviews|NoticePeriod| City|CityArea| ZipCode|
| NewJob |  Developer  | IT software | Software Developer| Pune    | 800000 |350000 | 700000 |   3    |  6    | 2            |60          | Pune |VimanNagar| 42001|
And Click on add candidate
...
Examples:
|Username        |NewEmployerLogin   |Password | CandidateEmail       | Name        |NewEmployerName|ContactNumber|Designation    |Date       | Gender |OnNoticePeriod | NoticePeriod |experience | CTC    |expectedCTC | Country|City  |CityArea    |ZipCode |Communicationmode |Salaryoffered|Salaryoffered2|distance|permanentAddress|relocate|OrganizationName|contactnumber|TimeZone                    				   |
|pemp@gmail.com  |EmpNew01@gmail.com |12345    | hircadjof07@gmail.com| hircadjof07 |EmpNew01       |9120601966   |Software Tester|04/08/1999 | Male   |   No          |  30          |  2.5      | 300000 | 400000     | India  | Pune | Viman Nagar| 411014 |  SMS             |             |  380000      |4       | No             | No     | EmpOrg         |123456789    |(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi|
...
And Add Salary Offered value and save changes "<Salaryoffered2>"
And Logout from App
And Newly registered user logged in to Application "<NewEmployerName>" "<NewEmployerLogin>" "9410143214" "Employer" "<TimeZone>" "<Country>" "<Password>" "Hyderabad" "EmpNew02ORG" "EmpNew02ORG.com" "Hyderabad" 
And Newly registered employer user creates new job 
| JobTitle| Designation|Industry     |FunctionalArea     |Location | Budget | MinSal| MaxSal | MinExp | MaxExp|NoOfInterviews|NoticePeriod| City|CityArea| ZipCode|
| NewJob |  Developer  | IT software | Software Developer| Pune    | 800000 |350000 | 700000 |   3    |  6    | 2            |60          | Pune |VimanNagar| 42001|
And Click on add candidate
...
|pemp@gmail.com |EmpNew02@gmail.com |12345   | hircadjof08@gmail.com| hircadjof08 |EmpNew02        |9120601966   |Software Tester|04/08/1999 | Male   |   No          |  30          |  2.5      | 300000 | 400000     | India  | Pune | Viman Nagar| 411014 |  SMS             |             |  380000      |400000        |4       | No             | No     | EmpOrg         |123456789    |(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi|
...
And Add Salary Offered value and save changes "<Salaryoffered2>"
And Logout from App
And Newly registered user logged in to Application "<NewEmployerName>" "<NewEmployerLogin>" "9410143214" "Employer" "<TimeZone>" "<Country>" "<Password>" "Hyderabad" "EmpNewv01ORG" "EmpNewv01ORG.com" "Hyderabad" 
And Newly registered employer user creates new job 
| JobTitle| Designation|Industry     |FunctionalArea     |Location | Budget | MinSal| MaxSal | MinExp | MaxExp|NoOfInterviews|NoticePeriod| City|CityArea| ZipCode|
| NewJob |  Developer  | IT software | Software Developer| Pune    | 800000 |350000 | 700000 |   3    |  6    | 2            |60          | Pune |VimanNagar| 42001|
And Click on add candidate
...
Examples:
|Username       |NewEmployerLogin   |Password| CandidateEmail       | Name        |NewEmployerName |ContactNumber|Designation    |Date       | Gender |OnNoticePeriod | NoticePeriod |experience | CTC    |expectedCTC | Country|City  |CityArea    |ZipCode |Communicationmode |Salaryoffered|Salaryoffered2|Salaryoffered3|distance|permanentAddress|relocate|OrganizationName|contactnumber|TimeZone                    				   |
|pemp@gmail.com |EmpNew02@gmail.com |12345   | hircadjof09@gmail.com| hircadjof09 |EmpNew02        |9120601966   |Software Tester|04/08/1999 | Male   |   No          |  30          |  2.5      | 300000 | 400000     | India  | Pune | Viman Nagar| 411014 |  SMS             |             |  380000      |400000        |4       | No             | No     | EmpOrg         |123456789    |(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi|

Feature: HireXpert Login & Registration feature
	...
	Then verify User should get a error message as "User with 'txe3088@gmail.com' already register with system as Candidate. Please use forgot password link to recover password."
	And click on Close button
	And Click on Yes button of confirmation popup
	...
	And click on Submit button
	And click on Yes button
	Then User should get a error message as "User with 'age3088@gmail.com' already register with system as Candidate. Please use forgot password link to recover password."
	And click on Close button
	And Click on Yes button of confirmation popup
	And Close the browser
	Given User open browser
	...
	And click on Submit button
	And click on Yes button
	Then User should get following error message as "User with 'mike3088@gmail.com' already register with system as Candidate. Please use forgot password link to recover password."
	And click on Close button
	And Click on Yes button of confirmation popup
	And Close the browser
	Examples: 

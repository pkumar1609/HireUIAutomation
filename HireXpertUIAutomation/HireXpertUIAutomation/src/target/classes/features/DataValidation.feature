...
#And click on update profile option
Then Assert the personal and professional details of candidate "<profiletitle>" "<CandidateEmail>" "<ContactNumber>" "<Date>" "<country>" "<CityArea>" "<Name>" "<alternateemail>" "<alternateContact>" "<Gender>" "<City>" "<ZipCode>" "<currentorganization>" "<currentdesignation>" "<functionalArea>" "<currentduration>" "<jobtype>" "<shift>" "<preferredcity>" "<searchkeyword>" "<industry>" "<experience>" "<expectedCTC>" "<residentialstatus>" "<OnNoticePeriod>" "<LastWorkingDay>" "<NoticePeriod>" "<CTC>" "<Communicationmode>" "<willingtotravel>" "<lookingforjob>" "<relocate>" "<cv>"
And click on qualification tab
...
|pemp@gmail.com|pe1@gmail.com |12345   |hirecan42@gmail.com |Sr.software engineer  |hirecan42 |hirecan42@yahoo.com|78996685538    |9846355555      |Candidate|Indian Standard Time    | India |Accenture          |Sr.developer       |2   			|Contractual Full Time|Evening Shift|Pune         |14/09/2020   |Female  |Yes           |25/12/2020    |25          |can13        |IT software|1.7       |700000|800000     |Nagpur|sita bardi |248966 |Call             |Citizen          |Yes		     	 |No           |No      |C:\\Users\\TLP33\\Documents\\CV.docx|
...
|pemp@gmail.com|12345   |hirecan41@gmail.com|

...
And Select value from dropdown for candidate "<CandidateUserType>" "<timezone>" "<country>"
	...
	| TXE15          |  txe2087@gmail.com    | 285248688             | Employer         | (GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi           | India   | 12345       | Viman Nagar     |  EmpMain                 | www.mainemp.com |   Pune       | Age14        | age2087@gmail.com  |  1236556659         | Agency         | Viman Nagar   |   MainAgency           | www.mainag.com | Pune       | Mike15          | mike2087@gmail.com  | 369497878              | Candidate         |Test Engineer | Software Tester |   30         | IT-Software |  Pune         | Male   | Intermediate    |
	...
	Then User should get a error message as "User with 'txe2087@gmail.com' already register with system as Employer. You can not register same email Id as Candidate."
	And click on Close button
	And Click on Yes button of confirmation popup
	...
	And Select value from dropdown of "<candidateusertype>" "<timezone>" "<country>"
		And click on Submit button
	And click on Yes button
	Then User should get a error message as "User with 'age2087@gmail.com' already register with system as Agency. You can not register same email Id as Candidate."
	And click on Close button
	And Click on Yes button of confirmation popup
	And Close the browser
	Given User open browser
	...
	And click on Submit button
	And click on Yes button
	Then User should get a error message as "User with 'mike2087@gmail.com' already register with system as Candidate. You can not register same email Id as Employer."
	And click on Close button
	And Click on Yes button of confirmation popup
	And Close the browser
	...
	Examples: 
	   ...
	   | employermain01  |  txe2087@gmail.com  | 211394644               | Candidate          | (GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi | India    | agencymain01  |  age2087@gmail.com  | 211314644            | candidatemain01   |  mike2087@gmail.com   | 123456456               | Employer          | 
...
#	And click on ok button
	...
	|CPemployer09   | cpemployer2087@gmail.com   | 565566625             |   Employer       |  (GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi |  India  | Viman Nagar     | EmployerOrg              | www.employerorg.com | Pune         | 12345    | 12345678    | 12345678        | CPagency09   | CPagency2087@gmail.com   |  98563248           | Agency         | Viman Nagar   | CPAgency               | www.cpagency.com  | Pune       |
...
#	And click on ok button
	...
	| UPAgency16   | upagency2087@gmail.com    | 5685263125          |   Agency       | (GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi  |  India  | Viman Nagar   | AgencyOrg              | www.agencyorg.com | Pune       | OrgAgency        | 12345    |UPEmployer16  | upemployer2087@gmail.com   | 565566625             |   Employer       | Viman Nagar     | EmployerOrg              | www.employerorg.com | Pune         | OrgEmployer      |UPCandidate16   | upcandidate2087@gmail.com  | 9564783126    | Candidate             | India   |Test Engineer  | Software Tester |   30         | IT-Software |  Pune         | Male    | Intermediate   |java           |2         |250000 |No            |Day Shift|Permanent Full Time|45          |350000     |Wakad   ||30/12/2020    |
...
#	When click on Employer-Agency SignIn link
	...
	Then Verify that user get an error message as "aa2087bb@gmail.com is not registered with us. Please register first." or not
